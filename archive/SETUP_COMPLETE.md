# ARCHIVED — DO NOT USE
> This March 24 setup doc listed files that have since been **intentionally deleted**.
> Following its instructions would break the project. Read `CLAUDE.md` instead.
