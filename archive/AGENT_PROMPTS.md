# ARCHIVED — DO NOT USE
> This file contained incorrect instructions (e.g. CORS fix that breaks Electron, wrong file paths).
> It has been superseded. Read `CLAUDE.md` for the authoritative project constraints.
