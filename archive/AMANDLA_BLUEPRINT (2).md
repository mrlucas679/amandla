# ARCHIVED — DO NOT USE
> This is the original hackathon build script (March 21). It has been superseded by
> `AMANDLA_FINAL_BLUEPRINT.md` which wins on all conflicts.
> Do NOT follow the build order or code examples in this file.
